...
// Local icons for brands since they are removed from lucide-react
const InstagramIcon = () => (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xl font-bold text-white">GreenHaven</span>
            </div>
            <p className="text-green-300 text-sm leading-relaxed">
              Your trusted companion for indoor plant care, expert consultations, and a greener home.
            </p>
          </div>
